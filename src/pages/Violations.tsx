...
const mockViolations: Violation[] = [
  ...
  {
    id: "V-006",
    timestamp: "2024-01-20 09:55:33",
    licensePlate: "UP 32 MN 2468",
    vehicleType: "Bike",
  ...
  {
    id: "V-008",
    timestamp: "2024-01-20 08:45:50",
    licensePlate: "UP 16 RS 8642",
    vehicleType: "Bike",
  ...
  {
    id: "V-009",
    timestamp: "2024-01-20 08:20:05",
    licensePlate: "UP 32 TU 9753",
    vehicleType: "Car",
  ...
  {
    id: "V-010",
    timestamp: "2024-01-20 07:55:28",
    licensePlate: "UP 70 VW 4680",
    vehicleType: "Bike",
    violationType: "Speed Violation",
        ...
        <TableBody>
          {sortedViolations.map((violation) => (
            <TableRow key={violation.id} className="hover:bg-secondary/50 border-border">
              ...
              <TableCell>
                <code className="px-2 py-1 bg-yellow-500/20 text-yellow-300 rounded text-sm font-mono font-bold border border-yellow-500/50">
                  {violation.licensePlate}
                </code>
              </TableCell>
              <TableCell>
                <Badge variant="outline" className={getVehicleTypeColor(violation.vehicleType)}>
